...
class AthenaClient:
    ...
    def poll_query(self, execution_id: str, timeout: int = 25) -> str:
        """
    ...
    def get_results(self, execution_id: str) -> List[Dict[str, Any]]:
        ...
        for page in paginator.paginate(QueryExecutionId=execution_id):
            ...
            if column_names is None:
                # First page: extract header from first row
    ...
    def run_query(self, sql: str, timeout: int = 25) -> List[Dict[str, Any]]:
        """
